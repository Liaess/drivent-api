...
export class CreatingEntitiesToActivityFeature1631220746336 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
      ...
      await queryRunner.query("CREATE TABLE \"activities\" (\"id\" SERIAL NOT NULL, \"date\" TIMESTAMP NOT NULL, \"locationId\" integer NOT NULL, \"beginsAt\" character varying NOT NULL, \"finishesAt\" character varying NOT NULL, \"title\" character varying NOT NULL, \"remainingSeats\" integer NOT NULL, CONSTRAINT \"PK_7f4004429f731ffb9c88eb486a8\" PRIMARY KEY (\"id\"))");
